...
plot(km,lwd=c(4,4),lty=c(1,1),ylab="Overall Survival",xlab="Time Since Surgery (months)",main="Resec1 cohort",col=c('deepskyblue3','firebrick1'),cex.lab=1.25,cex.main=1.25,yaxt="n",xaxt="n",conf.int=F)
